      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 md:pt-20">
        ...
        <section className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8 items-start mb-20">
          ...
          <div className="lg:w-1/2 w-full">
            <div className="w-full h-[350px] rounded-[2rem] bg-slate-200 animate-pulse" />
          </div>
        </section>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-40 md:h-48 rounded-[1.5rem] bg-slate-200 animate-pulse" />
            ))}
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="space-y-4">
                    <div className="h-56 w-full rounded-[1.5rem] bg-slate-200 animate-pulse" />
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="h-64 rounded-[2rem] bg-slate-200 animate-pulse" />
            <div className="h-48 rounded-[2rem] bg-slate-200 animate-pulse" />
            <div className="h-72 rounded-[2rem] bg-slate-200 animate-pulse" />
          </div>
        </div>
      </div>
    </div>
