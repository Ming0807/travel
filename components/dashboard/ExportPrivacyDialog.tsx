...
const DETAILS: Record<ExportType, { includes: string; excludes: string }> = {
  summary: { includes: "ตัวชี้วัด แนวโน้มรายการเข้าชมรายวัน และอันดับสถานที่แบบรวม พร้อมขอบเขต ตัวหาร ข้อยกเว้น และรุ่นสูตรคำนวณ", excludes: "ข้อมูลรายบุคคล ข้อความอิสระ รหัสภายใน และผลเปรียบเทียบช่วงก่อนหน้า" },
