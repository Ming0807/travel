...
export default async function AdminBadgesPage({
  ...
  return (
    <ListPageShell
      ...
      createHref="/admin/badges/new"
      createLabel="เพิ่ม Badge ใหม่"
      headerActions={<ExportButton endpoint="/api/admin/export/badges" label="Export CSV" />}
      total={total}
      page={page}
      pageSize={pageSize}
      emptyTitle="ไม่พบ Badge"
