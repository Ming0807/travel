  ...
  return (
    <AdminShell>
      <section className="mx-auto max-w-xl rounded-lg border border-rose-200 bg-white p-6 text-center">
        ...
        <button type="button" onClick={reset} className="mt-5 min-h-11 rounded-md bg-[#073F37] px-5 text-sm font-bold text-white hover:bg-[#0A6B62]">ลองโหลดอีกครั้ง</button>
      </section>
    </AdminShell>
  );
}
