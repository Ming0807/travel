    ...
    <form action={handleSubmit} className="mx-auto max-w-4xl space-y-8 rounded-xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
      ...
      {isSuperAdmin && (
        <div className="flex items-start gap-3 rounded-lg bg-blue-50 p-4 text-blue-800 border border-blue-100">
          ...
          <div className="text-sm">
            <p className="font-bold">บทบาทผู้ดูแลระบบสูงสุด</p>
            <p className="mt-1">บทบาทหลักนี้มีสิทธิ์ทั้งหมดและไม่สามารถลดสิทธิ์หรือปิดใช้งานได้ เพื่อป้องกันระบบไม่มีผู้ดูแล</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div>
            <h3 className="text-lg font-semibold text-slate-900 border-b border-slate-200 pb-2 mb-4">รายละเอียดบทบาท</h3>
            ...
            <div className="space-y-5">
              <div>
                ...
                <div className="mt-2">
                  ...
                  <input
                    ...
                    required
                    pattern="[a-z_]+"
                    title="ใช้ตัวอักษรภาษาอังกฤษพิมพ์เล็กและขีดล่างเท่านั้น"
                    ...
                    placeholder="เช่น content_editor"
                  />
                </div>
                {isProtectedRole && (
                  <p className="mt-2 text-xs text-slate-500">ไม่สามารถเปลี่ยนรหัสของบทบาทระบบได้</p>
                )}
                {!isProtectedRole && (
                  <p className="mt-2 text-xs text-slate-500">ใช้ตัวอักษรภาษาอังกฤษพิมพ์เล็กและขีดล่างเท่านั้น</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  ...
                  <textarea
                    ...
                    required
                    className="block w-full rounded-lg border-0 py-2.5 px-4 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-[#F3704C] disabled:bg-slate-50 disabled:text-slate-500 sm:text-sm sm:leading-6 transition-all"
                    placeholder="อธิบายหน้าที่และขอบเขตการเข้าถึงของบทบาทนี้"
                  />
                </div>
              </div>
              ...
              <div className="pt-2">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-semibold text-slate-900">เปิดใช้งานบทบาท</h3>
                    <p className="text-xs text-slate-500 mt-1">อนุญาตให้นำบทบาทนี้ไปกำหนดให้ผู้ดูแล</p>
                  </div>
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="flex flex-col gap-6">
            <h3 className="text-lg font-semibold text-slate-900 border-b border-slate-200 pb-2">สิทธิ์ของบทบาท</h3>
      ...
      <div className="sticky bottom-0 z-10 -mx-6 -mb-6 mt-8 flex items-center justify-end gap-x-4 border-t border-slate-200 bg-white px-6 py-4 shadow-[0_-4px_6px_-1px_rgb(0,0,0,0.05)] sm:static sm:mx-0 sm:mb-0 sm:mt-8 sm:bg-transparent sm:px-0 sm:py-0 sm:pt-6 sm:shadow-none">
        ...
        >
          {isPending ? "กำลังบันทึก..." : initialData ? "บันทึกการเปลี่ยนแปลง" : "สร้างบทบาท"}
        </button>
      </div>
    </form>
  );
