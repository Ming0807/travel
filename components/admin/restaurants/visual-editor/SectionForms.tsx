  ...
  return (
    <form action={formAction} className="flex h-full flex-col">
      <div className="flex-1 space-y-6 overflow-y-auto p-6">
        ...
        <input type="hidden" name="coverImageUrl" value={restaurant.cover_image_url ?? ""} />
...
export function SettingsForm({ restaurant, provinces = [], onClose }: SectionFormProps) {
  const action = updateRestaurantAction.bind(null, restaurant.restaurant_id);
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const [state, formAction, isPending] = useActionState<any, FormData>(action, { success: false });
      ...
      <div className="flex-1 space-y-6 overflow-y-auto p-6">
        ...
        <div className="space-y-6">
          ...
          <label className="block">
            ...
            <input className="mt-2 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm" defaultValue={restaurant.cover_image_url ?? ""} name="coverImageUrl" />
