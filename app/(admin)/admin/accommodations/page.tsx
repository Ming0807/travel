...
export default async function AdminAccommodationsPage({
  ...
  return (
    <ListPageShell
      ...
      createHref="/admin/accommodations/new"
      createLabel="เพิ่มที่พักใหม่"
      headerActions={<ExportButton endpoint="/api/admin/export/accommodations" label="Export CSV" />}
      total={total}
      page={page}
      pageSize={pageSize}
      emptyTitle="ไม่พบข้อมูลที่พัก"
