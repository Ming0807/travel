          ...
          <section className="grid gap-6 xl:grid-cols-2">
            <form id="research-approval" action={recordResearchApprovalAction} className="scroll-mt-24 border border-[var(--admin-border)] bg-white p-5 xl:col-span-2">
              ...
              <div className="mt-4 grid gap-4 lg:grid-cols-2">
                ...
                <label className="text-sm font-bold">ระดับถ้อยคำในการวิเคราะห์<select name="analysisWording" required defaultValue={detail.study.analysisWording ?? ""} className="mt-2 min-h-11 w-full border border-slate-300 bg-white px-3 font-normal"><option value="" disabled>เลือกตามแผนที่อนุมัติ</option><option value="exploratory">สำรวจเบื้องต้น</option><option value="descriptive_associational">พรรณนาและวิเคราะห์ความสัมพันธ์</option><option value="confirmatory">ทดสอบสมมติฐานตามแผนที่อนุมัติ</option></select></label>
                ...
                <label className="text-sm font-bold">สถานะจริยธรรม<select name="ethicsReviewStatus" required defaultValue={detail.study.ethicsReviewStatus === "pending" ? "" : detail.study.ethicsReviewStatus} className="mt-2 min-h-11 w-full border border-slate-300 bg-white px-3 font-normal"><option value="" disabled>เลือกสถานะที่ตรวจสอบแล้ว</option><option value="not_required">ตรวจแล้ว ไม่เข้าข่ายต้องขอ</option><option value="approved">ได้รับอนุมัติแล้ว</option></select></label>
